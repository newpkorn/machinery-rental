    ...
    <td width="100%"><table id="Table_01" width="100%" height="0" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="2" rowspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0">
          <tr>
            <td><img src="../images/menu/search_rent.jpg" alt="" width="375" height="43" /></td>
          </tr>
          <tr>
            <td><fieldset>
              <legend>ข้อมูลการเช่า</legend>
              <table width="100%" border="0">
             <tr>
                  <td width=" " align="right">รหัสการเช่า</td>
			  ...
			  <form id="form2" name="form2" method="post" action="search_rent.php">
                ...
                <tr>
                  <td colspan="3"><table width="100%" border="1">
                    <tr>
                     <td width="8%" height="36" align="center" bgcolor="#0000FF"><span class="style2">รหัสการเช่า</span></td>
				  ...
				  <td width="10%" align="center"bgcolor="#0000FF"><span class="style2">เอกสาร</span></td>
				  <td width="8%" align="center"bgcolor="#0000FF"><span class="style2">ลบ</span></td>
                    </tr>
                 <?  
$sqlreserv=mysql_query("select * from   tb_lease , tb_member , tb_employee where  tb_lease.emp_id=tb_employee.emp_id  and  tb_lease.mem_id=tb_member.mem_id and  leas_id like '%$txt_search%' ");
						  ...
						  {?>
                <tr>
                  <td align="center" bgcolor="#CCFFFF"><span class="style1">
                    <?=$rsreserv[0];?>
                  </span></td>
                  ...
                  <td bgcolor="#CCFFFF">
			        <span class="style1">
				  <?		    $sqltype1=mysql_query("select * from   tb_lease_detail ,tb_machin  where  tb_machin.mac_id=tb_lease_detail.mac_id and leas_id='$rsreserv[leas_id]' ");
...
echo thai_date1($eng_date2);?> 
                ...
                <td align="center" bgcolor="#CCFFFF"><A HREF="form_print.php?idl=<?=$rsreserv[0];?>" target="_blank" class="style1">พิมพ์</A></td>
				<td align="center"bgcolor="#CCFFFF"><div align="center" class="style1"><a href="del_Rent.php?del_id=<?=$rsreserv[0]?>" onClick='return Conf(this)' >ลบ</a></div></td>
                </tr>
<?}?>
