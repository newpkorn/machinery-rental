    ...
    <td width="100%"><table id="Table_01" width="100%" height="0" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<table width="100%" border="0">
            ...
            <tr>
              <td><img src="../images/menu/rent_detail.jpg" alt="" width="375" height="43" /></td>
            </tr>
            <tr>
            <td><fieldset>
          ...
          <table width="100%"  border="0">
                ...
                <tr>
                  <td colspan="5"><table width="100%" border="1">
                    <tr>
                      <td width="8%" height="37" align="center" bgcolor="#0000FF"><span class="style2">รหัสการเช่า</span></td>
                  <td width="13%"align="center" bgcolor="#0000FF"><span class="style2">สมาชิก</span></td>
                  <td width="13%" align="center"bgcolor="#0000FF"><span class="style2">พนักงานดูแล</span></td>
                  <td width="30%" align="center"bgcolor="#0000FF"><span class="style2">เครื่องจักรกล</span></td>
                  <td width="10%" align="center"bgcolor="#0000FF"><span class="style2">วันที่เช่า</span></td>
                  <td width="10%"align="center" bgcolor="#0000FF"><span class="style2">วันที่คืน</span></td>
				   <td width="10%"align="center" bgcolor="#0000FF"><span class="style2">สถานะ</span></td>
				   <td width="10%" align="center"bgcolor="#0000FF"><span class="style2">รับคืน</span></td>
                    </tr>
                 <?  
				 		     include("../inc_connect.php"); 
  $sqlreserv=mysql_query("select * from   tb_back , tb_member , tb_employee where  tb_back.emp_id=tb_employee.emp_id  and  tb_back.mem_id=tb_member.mem_id and leas_id='$idl' ");
		 $rsreserv= mysql_fetch_array($sqlreserv);
                ...
                <tr>
                  ...
                  <td bgcolor="#CCFFFF">
			        <span class="style3">
				  <?		    $sqltype1=mysql_query("select * from   tb_back_detail ,tb_machin  where  tb_machin.mac_id=tb_back_detail.mac_id and leas_id='$rsreserv[leas_id]' ");
...
echo thai_date1($eng_date2);?> 
          ...
          <td align="center"bgcolor="#CCFFFF"><div align="center" class="style3">	<?		    $sqltype1s=mysql_query("select * from   tb_back_detail ,tb_machin  where  tb_machin.mac_id=tb_back_detail.mac_id and leas_id='$rsreserv[leas_id]' ");
						  while($rstype1s= mysql_fetch_array($sqltype1s)){?>
				  
				 <?if($rstype1s[b_status]==1){echo"คืนแล้ว";}?><?if($rstype1s[b_status]==2){echo"<FONT  COLOR=\"red\">ยังไม่คืน</FONT>";}?><BR>
				  <?}?></div></td>
				<td align="center"bgcolor="#CCFFFF"><div align="center" class="style3">	<?		    $sqltype1=mysql_query("select * from   tb_back_detail ,tb_machin  where  tb_machin.mac_id=tb_back_detail.mac_id and leas_id='$rsreserv[leas_id]' ");
						  while($rstype1= mysql_fetch_array($sqltype1)){?>
				  
				  <A HREF="addReturn.php?idleas=<?=$rstype1[leas_id];?>&idmac=<?=$rstype1[mac_id];?>">รับคืน</A><BR>
				  <?}?></div></td>
                </tr>
