    ...
    <td width="23%" height="114" bgcolor="#E7E6E6"><table width="100%" height="49"  border="0">
      <tr>
        <td width="100%" height="45"><center>
            <span class="style2"><strong>ชื่อผู้ใช้งาน</strong></span> : <?=$_SESSION['emp_name']?>
        </center></td>
      </tr>
    </table>
      ...
      <tr>
        ...
        <td colspan="2" rowspan="2" valign="top" bgcolor="#FFFFFF">
		 ...
		 <? 
            ...
            <tr>
              <td >&nbsp;</td>
              <td><input type="submit" name="Submit3" value="Save" />
                <input type="reset" name="Submit4" value="Reset" /></td>
              </tr>
