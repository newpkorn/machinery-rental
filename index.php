...
<!--คำสั่งนี้คือส่งค่าอยู่หน้าเดิม$PHP_SELF -->
  <td width="33%" height="" align="center" valign='top' bordercolor='back' border='1'>
	...
	<?
	$sql_show = mysql_query("select * from  tb_machinery_unit where unit_id='$data[mac_unit]'");
	$data2=mysql_fetch_array($sql_show);

?>

    <table width="80%" border="0" cellspacing="0">
      <tr>
        <td width="70%" bgcolor="#FFFFCC" align="center"><font size="-1"><?php echo $data['mac_name'] ?><BR>฿<?php echo $data['mec_price'] ?>/<?=$data2['unit_name'] ?></td>
      </tr>
    </table>
