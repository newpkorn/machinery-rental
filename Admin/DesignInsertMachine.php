                    ...
                    <table width="125%" border="0">
                        ...
                        <td colspan="2">
                          ...
                          <table width="111%" border="0">
                            ...
                            <tr>
                              ...
                              <td><label for="iiii"></label>
                                ...
                                <select name="brand" id="brand">
                                  ...
                                  if ($sqlbrand && mysqli_num_rows($sqlbrand) > 0) {
                            ...
                            <tr>
                              ...
                              <td><label for="type"></label>
                                <select name="type" id="type">
                                  ...
                                  if ($sqltype && mysqli_num_rows($sqltype) > 0) {
                                    while ($rstype = mysqli_fetch_array($sqltype)) {
                                  ?>
                                      <option value="<?php echo $rstype[0]; ?>"><?php echo $rstype[1]; ?></option>
                                  <?php }
                                  } ?>
                                </select>
                                <span class="style1">*</span>
                              ...
                              <td><input name="price" type="text" id="price" size="20" maxlength="7" onKeyPress="CheckNum()" / /><select name="mach_unit">
                                  ...
                                  if ($sqlunit && mysqli_num_rows($sqlunit) > 0) {
                                    while ($rsunit = mysqli_fetch_array($sqlunit)) {
                                  ?>
                                      <option value="<?= $rsunit[0]; ?>"><? if ($row_show["mac_unit"] === $rsunit[0]) "selected"; ?><?= $rsunit[1]; ?></option>
                                  <?php }
                                  } ?>
                            ...
                            <tr>
                              ...
                              <td><label for="status"></label>
                                <select name="status" id="status">
                                  ...
                                  if ($sqlstatus && mysqli_num_rows($sqlstatus) > 0) {
                                    while ($rsstatus = mysqli_fetch_array($sqlstatus)) {
                                  ?>
                                      <option value="<?= $rsstatus[0]; ?>"><?= $rsstatus[1]; ?></option>
                                  <?php }
                                  } ?>
                                </select>
                                <span class="style1">*</span>
                              ...
                              <td><label for="control"></label>
                                <select name="control" id="control">
                                  ...
                                  if ($sqlcontrol && mysqli_num_rows($sqlcontrol) > 0) {
                                    while ($rscontrol = mysqli_fetch_array($sqlcontrol)) {
                                  ?>
                                      <option value="<?= $rscontrol[0]; ?>"><?= $rscontrol[1]; ?></option>
                                  <?php }
                                  } ?>
                                </select>
                                <span class="style1">*</span>
                            ...
                            <tr>
                              ...
                              <td width="25%"><input name="pic" type="file" id="ic" size="30" value="" /></td>
                              <td width="8%"></td>
                              <td width="30%"></td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        ...
                        <td><input type="submit" name="Submit3" value="เพิ่มข้อมูล" />
                          <input type="reset" name="Submit4" value="ล้างข้อมูลReset" />
                        </td>
                      </tr>
