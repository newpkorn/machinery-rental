...
function NewCal(pCtrl, pFormat, pShowTime, pTimeMode, pScroller, pHideSeconds) {
  ...
  if (pScroller != null) {
    if (pScroller.toUpperCase() == 'ARROW') Cal.Scroller = 'ARROW';
  ...
  if (exDateTime != '') {
    ...
    var offset =
      parseInt(Cal.Format.toUpperCase().lastIndexOf('M')) -
      parseInt(Cal.Format.toUpperCase().indexOf('M')) -
      1;
    if (
      ...
      Cal.Format.toUpperCase() == 'YYYYMMDD' ||
  ...
  winCal = window.open(
    '',
    'DateTimePicker',
    'toolbar=0,status=0,menubar=0,fullscreen=no,width=230,height=245,resizable=0,top=' +
      cnTop +
      ',left=' +
      cnLeft
  );
...
function RenderCal() {
  ...
  vCalHeader =
    '<table border=1 cellpadding=1 cellspacing=1 width=200 valign="top">\n';
  ...
  if (Cal.Scroller == 'DROPDOWN') {
    vCalHeader +=
      '<td align=\'left\'><select name="MonthSelector" onChange="javascript:winMain.Cal.SwitchMth(this.selectedIndex);winMain.RenderCal();">\n';
    for (i = 0; i < 12; i++) {
  ...
  //******************Month selector in arrow*********************************
    ...
    vCalHeader +=
      "<td align='center'><a href='javascript:winMain.Cal.DecYear();winMain.RenderCal();'>- </a></td>"; //Year scroller (decrease 1 year)
    vCalHeader +=
      "<td align='center'><a href='javascript:winMain.Cal.DecMonth();winMain.RenderCal();'>&lt;</a></td>"; //Month scroller (decrease 1 month)
    vCalHeader +=
      "<td align='center' width='70%'><font face='Verdana' size='2' color='" +
      YrSelColor +
      "'><b>" +
      Cal.GetMonthName(ShowLongMonth) +
      ' ' +
      Cal.Year +
      '</b></font></td>'; //Month and Year
    vCalHeader +=
      "<td align='center'><a href='javascript:winMain.Cal.IncMonth();winMain.RenderCal();'>&gt;</a></td>"; //Month scroller (increase 1 month)
    vCalHeader +=
      "<td align='center'><a href='javascript:winMain.Cal.IncYear();winMain.RenderCal();'>+</a></td>"; //Year scroller (increase 1 year)
  ...
  for (j = 1; j <= Cal.GetMonDays(); j++) {
    ...
    if (
      ...
      if (
        ...
        if (MondayFirstDay == true) {
          if (vDayCount % 7 == 0) strCell = GenCell(j, false, SundayColor);
...
function GenCell(pValue, pHighLight, pColor) {
  ...
  if (Cal.ShowTime) {
    vTimeStr =
      ...
      "+':'+" +
      'winMain.Cal.Minutes';
    if (Cal.ShowSeconds) vTimeStr += "+':'+" + 'winMain.Cal.Seconds';
