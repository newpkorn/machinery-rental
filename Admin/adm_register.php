...
<?php
	...
	$pass= $_POST[txtPass];
	 ...
	 $sql_show = "select * from  tb_admin where adm_id='$txtID'";
...
$num_show=mysql_num_rows($result_show);
	if ($num_show!=0) {
	 ...
	 $sql_show2 = "select * from  tb_admin where adm_user='$txtUser'";
...
echo "<meta http-equiv='refresh' content='0; url=InsertAdmin.php'>";
 ...
 echo "<meta http-equiv='refresh' content='0; url=InsertAdmin.php'>";
	...
	$insert = "insert into tb_admin values ('$admID', '$admName','$user', '$pass', '$birthDay', '$sex', '$add' ,'$phone', '$admPos')"; 
 ...
 echo "<meta http-equiv='refresh' content='0; url=search_admin.php'>";
		...
		echo"<SCRIPT>alert('รหัสเจ้าผู้ดูแลระบบนี้มีอยู่แล้ว');</SCRIPT>";
 echo "<meta http-equiv='refresh' content='0; url=InsertAdmin.php'>";
		exit();
	}
