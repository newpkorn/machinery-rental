...
?><br>
                    ...
                    <table width="100%" border="0">
                      <tr>
                      	<td width="10%" height="30" bgcolor="#0066CC"><div align="center" class="style2"><strong>รหัส</strong></div></td>
                        <td width="20%" bgcolor="#0066CC"><div align="center" class="style5">ชื่อ</div></td>
                        <td width="10%" bgcolor="#0066CC"><div align="center" class="style5">ทะเบียน</div></td>
          <td width="15%" bgcolor="#0066CC"><div align="center" class="style5">ยี่ห้อ</div></td>
          <td width="15%" bgcolor="#0066CC"><div align="center" class="style5">ประเภท</div></td>
          <td width="7%" bgcolor="#0066CC"><div align="center" class="style5">ราคา</div></td>
          <td width="5%" bgcolor="#0066CC"><div align="center" class="style5">สถานะ</div></td>
		  		  <td width="5%" bgcolor="#0066CC"><div align="center" class="style5">รูปภาพ</div></td>
          <td width="15%" bgcolor="#0066CC"><div align="center" class="style5">ผู้ดูแล</div></td>
          <td width="5%" bgcolor="#0066CC"><div align="center" class="style5">แก้ไข</div></td>
          <td width="5%" bgcolor="#0066CC"><div align="center" class="style5">ลบ</div></td>
                      </tr>
...
?>
        ...
        <td bgcolor="#CCFFFF"><span class="style4">
          ...
          <td bgcolor="#CCFFFF"><span class="style4">
		    ...
		    <td bgcolor="#CCFFFF"><A HREF="../images_machinery/<?if($row_show[mac_picture]!=""){echo"$row_show[mac_picture]";}else{echo"nopic.jpg";}?>" target="_blank" class="style6">ดูภาพ</A></td>
          <td bgcolor="#CCFFFF"><span class="style4">
            <?=$row_show['control_name']?>
          </span></td>
          <td bgcolor="#CCFFFF"><div align="center" class="style4"><a href="editMachin.php?edit_id=<?=$row_show['mac_id']?>"><img src="../images/edit.gif" alt="" width="15" height="15"></a></div></td>
           <td bgcolor="#CCFFFF"><div align="center" class="style4"><a href="del_Machin.php?del_id=<?=$row_show[mac_id]?>" onClick='return Conf(this)' ><img src="../images/delete.gif" alt="" width="15" height="15"></a></div></td>
        </tr>
        <?
}
?>
