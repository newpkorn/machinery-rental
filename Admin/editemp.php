                        ...
                        <table width="100%" border="0" bgcolor="#99FFFF">
                          ...
                          <tr>
                            ...
                            <td bgcolor="#CCFFFF"><label for="txtID"></label>
                              <input type="text" name="txtID" id="txtID" value="<?= $row_show['emp_id'] ?>" readonly />
                          ...
                          <tr>
                            ...
                            <td bgcolor="#CCFFFF"><label for="txtName"></label>
                              ...
                              <input type="text" name="txtName" id="txtName" value="<?= $row_show['emp_name'] ?>" />
                              <span class="style2">*</span>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td bgcolor="#CCFFFF"><label for="txtPos"></label>
                              <select name="txtPos" id="txtPos">
                                ...
                                <?php
                                $sqlposition = mysqli_query($conn, "select * from  tb_position");
                                while ($rsposition = mysqli_fetch_array($sqlposition)) {
                                ?>
                                  <option value="<?php echo $rsposition[0]; ?>" <?php if ($row_show["Position_id"] === $rsposition[0]) echo " selected "; ?>><?php echo $rsposition[1]; ?></option>
                                <?php } ?>
                              </select>
                            </td>
                          </tr>
                            ...
                            <td bgcolor="#CCFFFF">
                              <table width="114" border="0">
                                <tr>
                                  ...
                                  <td width="55"><a href="search_employee.php"><input type="button" name="cancel" id="cancel" value="ยกเลิก" /></a></td>
                                  <td width="140">&nbsp;</td>
                                </tr>
                              </table>
                            </td>
