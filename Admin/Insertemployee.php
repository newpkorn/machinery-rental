...
<body>
  <center>
    <form name="form1" method="post" onSubmit="return chkdata();" action="emp_register.php">
        ...
        <tr valign="top">
          <td width="23%" height="114" bgcolor="#E7E6E6">
            ...
            <table width="93%" height="146" border="0" align="center" bgcolor="#FFFFFF">
              ...
              <tr>
                <td height="34"><img src="../images/impersonal.gif" alt="" width="16" height="16">&nbsp;<a href="search_employee.php">ข้อมูลเจ้าหน้าที่</a></td>
              </tr>
              <tr>
                <td height="34"><img src="../images/addg.GIF" alt="" width="15" height="15">&nbsp;<a href="Insertemployee.php">เพิ่มข้อมูลเจ้าหน้าที่</a></td>
              </tr>
              <tr>
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#99FFFF">
                        <table width="100%" border="0" bordercolor="#CCFFFF">
                          <tr>
                            <td colspan="2" align="center"><span class="style5">เพิ่มข้อมูลเจ้าหน้าที่</span></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td bgcolor="#CCFFFF"><label for="txtPos"></label>
                              ...
                              <select name="txtPos" id="txtPos">
                                <?php
                                $sqlposition = mysqli_query($conn, "SELECT * FROM  tb_position") or die(mysqli_connect_error($conn));
                                if (mysqli_num_rows($sqlposition) > 0) {
                                  while ($rsposition = mysqli_fetch_array($sqlposition)) {
                                ?>
                                    <option
                                      value="<?= $rsposition['pos_id'] ?>"><?= $rsposition['pos_name'] ?>
                                    </option>
                                <?php
                                  }
                                } else {
                          ...
                          <tr>
                            ...
                            <td bgcolor="#CCFFFF"><input type="text" name="txtBirth" size="10" id="StartDate[]" value="<?= $StartDate ?>" onKeyPress="CheckNum()" />
                              <a href="javascript:NewCal('StartDate[]','ddmmyyyy')"> <img src="../images/cal.gif" width="16" height="16" border="0" alt="Pick a date"> <span class="style3">* </span></a>
                            </td>
                          </tr>
                          <tr>
                            <td height="45" align="right" bgcolor="#CCFFFF"><span class="style4">
