                        ...
                        <table width="609" height="162" border="0" align="center">
                          ...
                          <tr>
                            <td colspan="2" align="center">
                              <form id="form1" name="form1" method="post" action="search_brand.php">
                                ค้นหาจากชื่อ
                          ...
                          <tr>
                            <td colspan="2">
                              ...
                              <table width="485" border="0" align="center">
                                <tr>
                                  <td width="271" height="26" bgcolor="#99FFFF">
                                    <div align="center" class="style1">ชื่อ</div>
                                  </td>
                                  <td width="115" bgcolor="#99FFFF">
                                    <div align="center" class="style1">แก้ไข</div>
                                  </td>
                                  <td width="85" bgcolor="#99FFFF">
                                ...
                                $sql_show = "SELECT * FROM tb_machinery_brand WHERE brand_id IS NOT NULL AND brand_name LIKE '%$txt_search%' ORDER BY brand_name";
                                ...
                                ?>
                                    <tr>
                                      <td bgcolor="#CCFFFF"><span class="style4">
                                          <?= htmlspecialchars($row_show['brand_name'], ENT_QUOTES, 'UTF-8') ?>
                                        </span></td>
                                      <td bgcolor="#CCFFFF">
                                        <div align="center" class="style4"><a href="editMachinBrand.php?edit_id=<?= $row_show['brand_id'] ?>">แก้ไข</a></div>
                                      </td>
                                      <td bgcolor="#CCFFFF">
                                        <div align="center" class="style4"><a href="del_MachinBrand.php?del_id=<?= $row_show['brand_id'] ?>" onClick='return Conf(this)'>ลบ</a></div>
                                      </td>
                                    </tr>
                                <?php
                                  }
