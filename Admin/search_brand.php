      ...
      <table width="100%" height="102"  border="0">
        ...
        <tr>
          <td width="100%" height="48"><center>
            <table width="93%" height="38"  border="0" bgcolor="#FFFFFF">
              <tr>
        ...
        <td colspan="2" rowspan="2" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0">
          ...
          <tr>
            <td colspan="2" rowspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0">
              ...
              <table width="609" height="162" border="0" align="center">
                <tr>
                  <td width="287" align="right"><img src="../images/icon_search11.gif" width="50" height="50" align="right"></td>
                  <td width="393"><span class="style51">ค้นหาข้อมูลยี่ห้อเครื่องจักรกล</span></td>
                </tr>
                <tr>
                  <td colspan="2" align="center"><form id="form1" name="form1" method="post" action="search_brand.php">
      ค้นหาจากชื่อ
...
<br>
                    ...
                    <table width="485" border="0" align="center">
                      <tr>
                      	<td width="271" height="26" bgcolor="#99FFFF"><div align="center" class="style1">ชื่อ</div></td>
          <td width="115" bgcolor="#99FFFF"><div align="center" class="style1">แก้ไข</div></td>
          <td width="85" bgcolor="#99FFFF"><div align="center" class="style1">ลบ</div></td>
                      </tr>
                      
                      <?
					  $txt_search = $_POST['txtKeyword'];
$sql_show = "select * from tb_machinery_brand where brand_id is not null and brand_name like '%$txt_search%'";
...
?>
        <tr>
        <td bgcolor="#CCFFFF"><?=$row_show['brand_name']?></td>
          <td bgcolor="#CCFFFF"><div align="center"><a href="editMachinBrand.php?edit_id=<?=$row_show['brand_id']?>">แก้ไข</a></div></td>
           <td bgcolor="#CCFFFF"><div align="center"><a href="del_MachinBrand.php?del_id=<?=$row_show[brand_id]?>" onClick='return Conf(this)' >ลบ</a></div></td>
        </tr>
        <?
}
?>
