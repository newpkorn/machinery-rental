                        ...
                        <table width="690" height="162" border="0" align="center">
                          ...
                          <tr>
                            <td colspan="2" align="center">
                              <form id="form1" name="form1" method="post" action="search_position.php">
                                ชื่อที่ต้องการค้นหา
                          ...
                          <tr>
                            <td colspan="2">
                              ...
                              <table width="457" border="0" align="center">
                                <tr>
                                  <td width="241" height="28" align="center" bgcolor="#99FFFF">
                                    <div align="center" class="style1">ชื่อ</div>
                                  </td>
                                  <td width="139" align="center" bgcolor="#99FFFF">
                                    <div align="center" class="style1">แก้ไข</div>
                                  </td>
                                  <td width="63" align="center" bgcolor="#99FFFF">
                                ...
                                $sql_show = "SELECT * FROM tb_position WHERE pos_id IS NOT NULL AND pos_name LIKE '%$txt_search%' ORDER BY pos_name";
                                ...
                                ?>
                                    <tr>
                                      <td bgcolor="#CCFFFF"><span class="style4">
                                          <?= htmlspecialchars($row_show['pos_name'], ENT_QUOTES, 'UTF-8') ?>
                                        </span></td>
                                      <td bgcolor="#CCFFFF">
                                        <div align="center" class="style4"><a href="editPosition.php?edit_id=<?= $row_show['pos_id'] ?>">แก้ไข</a></div>
                                      </td>
                                      <td bgcolor="#CCFFFF">
                                        <div align="center" class="style4"><a href="del_Position.php?del_id=<?= $row_show['pos_id'] ?>" onClick='return Conf(this)'>ลบ</a></div>
                                      </td>
                                    </tr>
                                <?php
                                  }
