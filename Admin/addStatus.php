...
<body>
<center>
  <form name="form1" method="post"  onSubmit="return chkdata();" action="insertStatus.php">
        ...
        <td width="23%" height="114" bgcolor="#E7E6E6"><table width="100%" height="49"  border="0">
          ...
          <table width="94%" height="38"  border="0" align="center" bgcolor="#FFFFFF">
            <tr>
              ...
              <tr>
                <td height="34"><img src="../images/edit.gif" alt="" width="15" height="15">&nbsp; <a href="search_status.php">ข้อมูลสถานะเครื่องจักรกล</a></td>
              </tr>
              <tr>
                <td height="34"><img src="../images/addg.GIF" alt="" width="15" height="15"> &nbsp;<a href="InsertAdmin.php">เพิ่มข้อมูลสถานะเครื่องจักรกล</a></td>
              </tr>
              <tr>
        ...
        <td width="77%"><table id="Table_01" width="100%" height="0" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="2" rowspan="2" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0">
              ...
              <tr>
                <td colspan="2"><table width="83%"  border="0" align="center" bgcolor="#CCFFFF">
                  <tr>
                    <td colspan="2" align="center" bgcolor="#99FFFF"><span class="style4">เพิ่มข้อมูลสถานะ</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="43" align="right" bgcolor="#CCFFFF"><span class="style2">&nbsp;ชื่อสถานะ : </span></td>
