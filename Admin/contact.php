              ...
              <tr>
                ...
                <td colspan="2" rowspan="2" valign="top" bgcolor="#FFFFFF">
                  <table width="100%" border="0">
                    ...
                    <tr>
                      <td colspan="2">
                        <table width="69%" border="0" align="center" bgcolor="#CCFFFF">
                          <tr>
                          ...
                          ?>
                              <tr>
                                ...
                                <td bgcolor="#CCFFFF">
                                  ...
                                  <TEXTAREA NAME="addr" id="addr" ROWS="5" COLS="40"><?= htmlspecialchars($row_show['contact_add'] ?? '') ?></TEXTAREA><span class="style1">*</span>
                                </td>
                              </tr>
                              <tr>
                                <td height="43" align="right" bgcolor="#CCFFFF"><span class="style3">&nbsp;โทรศัพท์ : </span></td>
                                <td bgcolor="#CCFFFF">
                                  <input type="text" name="tel" id="tel" size="15" value="<?= htmlspecialchars($row_show['contact_tel'] ?? '') ?>" maxlength="10" onKeyPress="CheckNum()" />
                              ...
                              <tr>
                                ...
                                <td bgcolor="#CCFFFF">
                                  <input type="text" value="<?= htmlspecialchars($row_show['contact_mail'] ?? '') ?>" name="email" id="email" size="50" />
                                  <span class="style1">*</span>
                                </td>
                              </tr>
                          <?php }
